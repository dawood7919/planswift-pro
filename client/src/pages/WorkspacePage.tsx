...
export default function WorkspacePage() {
  ...
  function submitTemplate() {
    ...
    if (!templateFormulaDiagnostic.valid) { toast.error(templateFormulaDiagnostic.message); return; }
    if (!templateDependencyDiagnostic.valid) { toast.error(templateDependencyDiagnostic.message); return; }
