...
const colors: Record<MeasurementKind, string> = { AREA: "#c9ff4a", ROOF_AREA: "#d7a6ff", VOLUME: "#a4f1c2", LINEAR: "#ff9c7b", SEGMENT: "#87d9f7", COUNT: "#f6cf62" };
